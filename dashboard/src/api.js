...
export default {
  ...
  pauseApp: (id, body) => request(`/apps/${id}/pause`, { method: 'POST', body: body || {} }),
  unpauseApp: (id, body) => request(`/apps/${id}/unpause`, { method: 'POST', body: body || {} }),
  getOnDemand: (id) => request(`/apps/${id}/on-demand`),
  ...
  getConstruction: (id) => request(`/apps/${id}/construction`),
  setConstruction: (id, body) => request(`/apps/${id}/construction`, { method: 'PUT', body: body || {} }),
  ...
  getServicePorts: (appId) => request(`/apps/${appId}/service-ports`),
  setServicePort: (appId, data) => request(`/apps/${appId}/service-ports`, { method: 'PUT', body: data }),
  deleteServicePort: (appId, portId) => request(`/apps/${appId}/service-ports/${portId}`, { method: 'DELETE' }),
